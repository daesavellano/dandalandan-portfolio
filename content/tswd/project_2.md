...
2. **The Conflict** (The Uninvited Guest):

    - Here, I transition from a *"Christmas is an amazing season"* to a *"...but not for everyone"* angle
    - Visualizations in this phase include photos after a storm, directly addressing comments in an in-class critique of my wireframe ("no shelter, no electricity, no Christmas").
    - I also included a quote that I found to be particularly striking: *"We always celebrated Christmas, but for now, it’s too hard."*

3. **The Human Cost** (A Dark Christmas):
    There are also visualizations and callout statistics regarding the human cost of typhoons, and specifically Christmas typhoons.
    - It starts with general statistics (i.e., #1 rank on World Risk Index, increasing frequency of storms, and the seasonal overlap of typhoons and the months leading to December)
    - There are general statistics on Pilippine internally displaced persons due to disasters, along with cost-breakdowns of wellbeing losses and asset losses
    - It is followed by stacked bar charts that highlight specific typhoons (Ruby, Nona, Tisoy, Ursula) that made landfall close to December 25. The charts visualize *"People Affected"* (millions) and *"Damaged Houses"*(hundreds of thousands).

4. **The Call to Action** (A Giving Christmas): In this section, I talk about how distance doesn't mean disconnection.
    - I use traditional Filipino context like *"bayanihan"*, along with matching photos.
    - I outline specific steps that can be done from the U.S., such as (donating, monitoring the PH government, organizing local initiatives, and sharing the story).
    - I emphasize the USD/PHP exchange rate, comparing a Philippine feast to an American cup of coffee.
