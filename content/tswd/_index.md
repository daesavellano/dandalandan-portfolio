...
<center><img src="/images/posts/tswd/tswd_intro.png" alt="Self-Intro" style="max-width: 100%; height: auto; max-height: 400px;" /></center>
...
Throughout the seven-week course, I developed a number of sample visualizations. Some of them can be found below.

- [Data Visualization Examples](/tswd/dataviz)
    - [Visualizing the Titanic Manifesto](/tswd/dataviz/#visualizing-the-titanic-manifesto)
    - [Recreating a Gapminder Chart with Tableau](/tswd/dataviz/#recreating-a-gapminder-chart-with-tableau)
    - [Government Debt-to-GDP Ratios](/tswd/dataviz/#government-debt-to-gdp-ratios)
    - [Learning Tableau and Datawrapper](/tswd/dataviz/#learning-tableau-and-datawrapper)
        - Tableau: [Trust in Media](/tswd/dataviz/#trust-in-media)
        - Datawrapper: [Popularity of Visualization Types](/tswd/dataviz/#popularity-of-datawrapper-visualization-types)
- [Government Debt-to-GDP Ratios](/tswd/government_debt): Longer Writeup
- Outside the Course
...
- [Part 1](/tswd/project_1): Proposal and Wireframe
- [Part 2](/tswd/project_2): Website Prototype and User Research
